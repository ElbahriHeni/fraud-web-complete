        ...
        {currentStep === 'review' ? (
          <div className="form-grid single">
            ...
            <div className="card" style={{ marginTop: 8 }}>
              <span className="eyebrow">{t.reviewCaseInfo}</span>
              <div className="activity-list top-gap">
                <div className="activity-item"><strong>{t.autoGeneratedCaseId}</strong><span>{caseId}</span></div>
                <div className="activity-item"><strong>{t.claimId}</strong><span>{displayValue(form.claimId)}</span></div>
                <div className="activity-item"><strong>{t.caseSource}</strong><span>{displayValue(form.caseSource)}</span></div>
                <div className="activity-item"><strong>{t.caseType}</strong><span>{displayValue(form.caseType)}</span></div>
                <div className="activity-item"><strong>{t.insuranceType}</strong><span>{displayValue(form.insuranceType)}</span></div>
                <div className="activity-item"><strong>{t.suspectedAmount}</strong><span>{displayValue(form.suspectedAmount)}</span></div>
                <div className="activity-item"><strong>{t.caseEntryDate}</strong><span>{displayValue(form.caseEntryDate)}</span></div>
                <div className="activity-item"><strong>{t.description}</strong><span>{displayValue(form.description)}</span></div>
              </div>
            </div>

            <div className="card">
              <span className="eyebrow">{t.reviewReporter}</span>
              <div className="activity-list top-gap">
                <div className="activity-item"><strong>{t.reporterName}</strong><span>{displayValue(form.reporterName)}</span></div>
                <div className="activity-item"><strong>{t.email}</strong><span>{displayValue(form.email)}</span></div>
                <div className="activity-item"><strong>{t.mobileNumber}</strong><span>{displayValue(form.mobileNumber)}</span></div>
                <div className="activity-item"><strong>{t.nationalId}</strong><span>{displayValue(form.nationalId)}</span></div>
              </div>
            </div>

            <div className="card">
              <span className="eyebrow">{t.reviewIndicators}</span>
              <div className="activity-list top-gap">
                <div className="activity-item"><strong>{t.fraudIndicatorType}</strong><span>{displayValue(form.fraudIndicatorType)}</span></div>
                <div className="activity-item"><strong>{t.indicatorDescription}</strong><span>{displayValue(form.indicatorDescription)}</span></div>
                <div className="activity-item"><strong>{t.occurrenceCount}</strong><span>{displayValue(form.occurrenceCount)}</span></div>
                <div className="activity-item"><strong>{t.fraudOfficerDecision}</strong><span>{displayValue(form.fraudOfficerDecision)}</span></div>
              </div>
            </div>

            <div className="card">
              <span className="eyebrow">{t.reviewFraudDetails}</span>
              <div className="activity-list top-gap">
                <div className="activity-item"><strong>{t.claimType}</strong><span>{displayValue(form.claimType)}</span></div>
                <div className="activity-item"><strong>{t.fraudConfirmedDate}</strong><span>{displayValue(form.fraudConfirmedDate)}</span></div>
                <div className="activity-item"><strong>{t.fraudDetectionMethod}</strong><span>{displayValue(form.fraudDetectionMethod)}</span></div>
                <div className="activity-item"><strong>{t.fraudAmount}</strong><span>{displayValue(form.fraudAmount)}</span></div>
                <div className="activity-item"><strong>{t.actionTaken}</strong><span>{displayValue(form.actionTaken)}</span></div>
                <div className="activity-item"><strong>{t.referredEntity}</strong><span>{displayValue(form.referredEntity)}</span></div>
              </div>
            </div>

            <div className="card">
              <span className="eyebrow">{t.reviewWorkflow}</span>
              <div className="activity-list top-gap">
                <div className="activity-item"><strong>{t.assignedUser}</strong><span>{displayValue(form.assignedUser)}</span></div>
                <div className="activity-item"><strong>{t.caseStatus}</strong><span>{displayValue(form.caseStatus)}</span></div>
                <div className="activity-item"><strong>{t.assignmentDate}</strong><span>{displayValue(form.assignmentDate)}</span></div>
                <div className="activity-item"><strong>{t.assignedBy}</strong><span>{displayValue(form.assignedBy)}</span></div>
                <div className="activity-item"><strong>{t.reassignmentReason}</strong><span>{displayValue(form.reassignmentReason)}</span></div>
                <div className="activity-item"><strong>{t.fraudUnitNotes}</strong><span>{displayValue(form.fraudUnitNotes)}</span></div>
              </div>
            </div>
